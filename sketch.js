...
function setup() {
	...
	rope = new chain (bobb.body, Roof.body, 0, 0);
	roope = new chain (bobbb.body, Roof.body, 0, 0);
	rooope = new chain (bobbbb.body, Roof.body, 0, 0);
	roooope = new chain (bobbbbb.body, Roof.body, 0, 0);
	rooooope = new chain (bobbbbbb.body, Roof.body, 0, 0);
